...
exports.deleteOne = (Model) => async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, data: doc, msg: "Deleted successfully" });
  } catch (error) {
...
exports.updateOne = (Model) => async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, data: doc, msg: "Data updated successfully" });
  } catch (error) {
    return next(new AppError(500, error.message, error.stacktrace));
  }
};
...
exports.createOne = (Model) => async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, data: doc, msg: "Created successfully" });
  } catch (error) {
    console.error(error);
    return next(new AppError(500, error.message, error.stacktrace));
  }
...
exports.readOne = (Model, populateOptions) => async (req, res, next) => {
  try {
    ...
    return res
      .status(200)
      .json({ status: true, data: doc, msg: "Data fetched successfully" });
  } catch (error) {
    return next(new AppError(500, error.message, error.stacktrace));
  }
};
...
exports.readMany =
  (Model, queryOption, populateOptions, sortOption, skip, pageSize) =>
  async (req, res, next) => {
    try {
